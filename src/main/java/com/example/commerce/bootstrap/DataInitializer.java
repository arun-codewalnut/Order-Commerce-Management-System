package com.example.commerce.bootstrap;

import com.example.commerce.customer.internal.Address;
import com.example.commerce.customer.internal.AddressRepository;
...
public class DataInitializer implements CommandLineRunner {
    ...
    public DataInitializer(CustomerRepository customerRepository, ProductRepository productRepository,
                           ...
                           NotificationRepository notificationRepository, AddressRepository addressRepository,
    ...
    public void run(String... args) {
        ...
        log.info("Seeding sample data for commerce-api...");
